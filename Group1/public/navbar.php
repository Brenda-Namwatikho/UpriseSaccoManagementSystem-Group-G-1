    ...
    <div class="sidebar-list">
        ...
        <div class="nav-item nav-loans">
            ...
            <div class="dropdown-menu">
                <a href="index.php?page=loan_status" class="dropdown-item">Loan Status</a>
                <a href="index.php?page=accepted_loans" class="dropdown-item">Active Loans</a>
                <a href="index.php?page=loan_reasons" class="dropdown-item">Rejected Loans</a>
				<a href="index.php?page=application_info" class="dropdown-item">Loan Applications</a>
                <a href="index.php?page=loan_payment" class="dropdown-item">Loan Payments</a>
